...
- Si vous avez des problème dans votre code, des questions et autres n'hésitez pas à faire un rapport de bug avec l'outil "issues" (avec le bon tag) [ici](https://github.com/h0ldhaven/Zone-De-Code/issues).
